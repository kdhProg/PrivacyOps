...
public class MissingDisposalPolicyRuleTest {

    @Test
    void createsFindingWhenDisposalIsMissing() {
        ...
        MissingDisposalPolicyRule rule =
    ...
    @Test
    void ignoresResourceWithDisposalPolicy() {
